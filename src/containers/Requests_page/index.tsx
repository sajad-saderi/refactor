      ...
      <section className="requests_page_container">
        ...
        >
          <div className="orders_tabs">
            ...
            >
              {language.REQUEST_PAGE.activeOrders}
            </p>
            <p
              onClick={() => {
                page = 1;
            ...
            >
              {language.REQUEST_PAGE.deactivateOrders}
            </p>
          </div>
          {activeTab === 1 ? (
                ...
                active_orders.length > 0 ? (
                  <>
                    {active_orders.map((item, i) => {
                      return (
                        <div className="Request_car" key={i} dir={activeLanguage === 'fa' ? 'rtl' : 'ltr'}>
                          <Request_cart
                            language={language}
                            data={item}
                            getDataAgain={() => {
                  ...
                  <p className="NoResult">{language.REQUEST_PAGE.noOrder}</p>
                )
              ) : (
                <>
      ...
      {showMoreButton ? (
        ...
        >
          {show_spinner_loadMore ? (
            ...
            <>
            <Icon name="chevronUp" rotate={180} width="24px" height="24px" color="#202020"/>
