  ...
  let price =
    avg_discounted_price_per_day >= 10000000
      ? avg_discounted_price_per_day >= 10100000
        ? numberChanger(
            (avg_discounted_price_per_day / 1000000).toString(),
            activeLanguage
          )
        : numberChanger(
            (avg_discounted_price_per_day / 10000000).toString(),
            activeLanguage
          )
          ...
          <div className='card_wrapper'>
            <figure>
              ...
              {total_discount_percent > 0 && (
                <span className='discount_badge'>
                  {numberChanger(
                    total_discount_percent.toString(),
                    activeLanguage
                  )}
            ...
            <div className='info_box'>
              ...
              <ul className='tags_container'>
                ...
                {deliver_at_renters_place && (
                  <li>
                    <span className='tags'>{language.COMMON.delivery}</span>
                  </li>
                )}
                {/* {with_driver && (
                  <li>
                ...
                {with_driver && (
                  <li>
                    <span className='tags'>{language.COMMON.withDriver}</span>
                  </li>
                )}
                {without_driver && (
                  <li>
