      ...
      >
        ...
        {// props.modal_type === "Login" ? (
          ...
          props.modal_type === "TellMe" ? (
            <TellMe
              language={props.language} data-test-id="TellMe" />
          ) : props.modal_type === "Renter" ? (
            <Renter
              language={props.language} data-test-id="Renter" data={props.data} />
          ) : props.modal_type === "Owner" ? (
            <Owner
              language={props.language} data-test-id="Owner" data={props.data} />
          ) : props.modal_type === "Law" ? (
            <Law
              language={props.language} data-test-id="Law" />
          ) : props.modal_type === "ConfirmDelete" ? (
            <ConfirmDelete
              language={props.language} data-test-id="ConfirmDelete" data={props.data} />
          ) : props.modal_type === "Assurance" ? (
            <Assurance
              language={props.language} data-test-id="Assurance" />
          ) : props.modal_type === "ImageModal" ? (
            <ImageModal
