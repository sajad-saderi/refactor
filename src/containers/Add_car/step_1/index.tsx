...
const Add_Car_Step_1 = ({ language }: IAdd_Car_Step_1) => {
  ...
  const [mileRange, setMileRange] = useState([
    {
      key: '1',
      value: '1',
      name: { fa: '۰ - ۵۰٫۰۰۰ کیلومتر', en: 'less than 50,000 KM' }
    },
    {
      key: '2',
      value: '2',
      name: {
        fa: '۵۰٫۰۰۰ - ۱۰۰٫۰۰۰ کیلومتر',
        en: 'Between 50,000 to 100,000 KM'
      }
    },
    {
      key: '3',
      value: '3',
      name: {
        fa: '۱۰۰٫۰۰۰ - ۲۰۰٫۰۰۰ کیلومتر',
        en: 'Between 100,000 to 200,000 KM'
      }
    },
    {
      key: '4',
      value: '4',
      name: { fa: '+۲۰۰٫۰۰۰  کیلومتر', en: 'more than 200,000 KM' }
    }
  ]);
  ...
  const getBrandInfo = async (id) => {
    ...
    try {
      ...
      if (model_info_res.cylinder) {
        incompleteInfo.cylinder.name[activeLanguage] =
          model_info_res.cylinder.name[activeLanguage];
        dispatch({
          type: 'cylinder_id',
      ...
      if (model_info_res.body_style) {
        incompleteInfo.body_style.name[activeLanguage] =
          model_info_res.body_style.name[activeLanguage];
        dispatch({
          type: 'body_style_id',
  ...
  return (
    <article
      className='responsive add_car_form_container'
      ...
      <form
        ...
        <p className='extra_text form_title'>
          {language.ADD_CAR_PAGE.formTitle}
        </p>
        <div className='car_location_district'>
          ...
          {!activeCities(state.location_id) ||
            (state.location_id !== null && !showDistrict && (
              <p className='extra_text'>
                {dynamicString(
                  [locationName[activeLanguage]],
                  language.ADD_CAR_PAGE.districtNote
                )}
              </p>
            ))}
        </div>
        ...
        <div className='value_container'>
          <Input
            ...
            tailValue={`${NumbersAndCurrencyUnit({
              value: state.value,
        ...
        <Button
          ...
          loading={Loading}
          disable={Loading}
          customClass='local_style HEAP_AddCar_Btn_Submit'
