...
const Contract_text = ({ result }: IContract_text) => {
    ...
    <div className="content">
      ...
      <div id="page_2">
        ...
        <p>
          ...
          است که مستأجر آن را در وب‌سایت سپریس (اجاره آنلاین خودرو)‌ پرداخت کرده
          است.
        </p>
        {result.has_insurance ? (
          <p>
            ...
            روز است که مستاجر آن را در وب‌سایت سپریس (اجاره آنلاین خودرو) پرداخت
            کرده است.
          </p>
        ) : null}
        <p>
        ...
        <p>
          ...
          با تمدید، کل مبلغ مدت تمدیدی را در سایت سپریس واریز نماید. در صورت عدم
          موافقت موجر با تمدید یا در صورت موافقت و عدم واریز مبلغ مدت تمدیدی‌،
          قرارداد اجاره منفسخ گردیده و مستأجر در صورت عدم عودت خودرو در پایان
          مدت قرارداد اجاره مسئول تمام خسارات خواهد بود.
        </p>
        ...
        <p>
          ...
          {` ${
            result.deposit_return_date
              ? result.deposit_return_date.name.fa.split("،")[0]
              : dots
          } `}{" "}
          به شماره کارت
          {` ${
      ...
      <div id="page_3">
        ...
        <p>
          ...
          <br />
          ۴- هزینه‌های از قبیل لنت‌، تعویض روغن‌، تایر، ضد یخ و سایر قطعات مصرفی
          به عهده موجر است.
          <br />
