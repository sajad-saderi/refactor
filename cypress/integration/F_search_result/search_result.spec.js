...
describe("تست صفحه نتایج جستجو", () => {
  ...
  it("تست های نتیجه درخواست های لیست برندها، لیست شهر ها، نتیجه جستجو", () => {
    ...
    cy.get(".Blue_BTN.search_Btn.HEAP_Home_Btn_Search")
      .click()
      .url()
      .should(
        "contain",
                    ...
                    cy.get(".minimal_filter_tags")
                      ...
                      .then(() => {
                        cy.url()
                          .should(
                            "not.contain",
                            "&deliver_at_renters_place=1&with_driver=1"
                          )
                          ...
                          .then(() => {
                            cy.get(
                              ".body_style_type_wrapper .check_box_container .container"
                            )
                              .eq(0)
                              .click()
                              .request(
                                            ...
                                            cy.get(".minimal_filter_tags")
                                              ...
                                              .then(() => {
                                                cy.url()
                                                  ...
                                                  .then(() => {
                                                    cy.get(
                                                      ".DropDown_container.Disable_Container"
                                                    )
                                                      .should("exist")
                                                      .get(
                                                      ...
                                                      .then(() => {
                                                        cy.url()
                                                          ...
                                                          .should("not.exist")
                                                          .get(
                                                            ".filter_section .DropDown_container:last-child"
                                                          )
                                                          .click()
                                                          .get(
                                                                                ...
                                                                                cy.get(
                                                                                  ...
                                                                                  .then(
                                                                                    (
                                                                                      ...
                                                                                      filter_label_value = win.document.querySelector(
                                                                                        ".minimal_filter_tags"
                                                                                      )
                                                                                        .textContent;
                                                                                      cy.url().should(
  ...
  it("بررسی منو در سایز 320 پیکسل", () => {
    ...
    cy.request(
      ...
      cy.get(".quick_access_child_container")
        .should("exist")
        ...
        .then((result) => {
          cy.get(".HEAP_Search_Result_Quick_Access_Economy")
            .click()
            .request(
              "GET",
              core_url +
  ...
  it("دکنه بیشتر در سایز دستکتاپ", () => {
    ...
    cy.request(
      ...
      cy.get(".Load_more_car.HEAP_SearchResult_Btn_ShowMore")
        .click()
        .request(
          "GET",
          core_url +
        ...
        .then((result) => {
          cy.get(".quick_access_middle_searchResult")
