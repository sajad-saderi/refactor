  ...
  return (
    <Layout showToTop={true}>
      <NextSeo
        ...
        description="در سایت اتولی هر اجاره‌دهنده می‌تواند شرایط متفاوتی برای اجاره ماشینش بگذارد که بسته به نوع ماشین می‌تواند متفاوت باشد"
        openGraph={{
          title: "مدارک و ضمانت های لازم | اتولی",
          description:
            "در سایت اتولی هر اجاره‌دهنده می‌تواند شرایط متفاوتی برای اجاره ماشینش بگذارد که بسته به نوع ماشین می‌تواند متفاوت باشد",
        }}
        twitter={{
          handle: "@otoli_net",
          site: "@otoli_net",
      ...
      <article className="responsive static_pages minHeight">
        ...
        <p>
          در سایت اتولی هر اجاره‌دهنده می‌تواند شرایط متفاوتی برای اجاره ماشینش
