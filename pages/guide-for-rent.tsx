      ...
      <section className="responsive static_pages minHeight">
        {activeLanguage === 'fa' ?
          <>
            ...
            <h2 id="guideForRentReserve">{locale.GUIDE_FOR_GUESTS_PAGE.h2_1}</h2>
            ...
            <h2 id="guideForRentCarDelivery">{locale.GUIDE_FOR_GUESTS_PAGE.h2_2}</h2>
            ...
            <h2 id="guideForRentTimeTravel">{locale.GUIDE_FOR_GUESTS_PAGE.h2_3}</h2>
            ...
            <h2 id="guideForRentEndOfJourney">{locale.GUIDE_FOR_GUESTS_PAGE.h2_4}</h2>
          ...
          : <>
            ...
            <h3><strong>{locale.GUIDE_FOR_GUESTS_PAGE.h3_1}</strong></h3>
            <p>{locale.GUIDE_FOR_GUESTS_PAGE.p1_2}</p>
            <br />
            <h3><strong>{locale.GUIDE_FOR_GUESTS_PAGE.h3_2}</strong></h3>
            <p>{locale.GUIDE_FOR_GUESTS_PAGE.p1_3}</p>
            <br />
            <h3><strong>{locale.GUIDE_FOR_GUESTS_PAGE.h3_3}</strong></h3>
