          ...
          <Page size='A4' style={styles.page}>
            ...
            <View>
              ...
              <Text style={styles.text}>
                ...
                {` ${result.rent_search_dump.owner.official_fathers_name} `}به
                شماره ملی ................................. شماره تماس ثابت
                {` ${result.rent_search_dump.owner.fixed_phone} `} شماره همراه
                {` 0${result.rent_search_dump.owner.cell} `} نشانی اقامتگاه
                .........................................................................................................................................................................................
              </Text>
              <Text style={styles.text}>
                مستأجر: آقا/خانم
                {` ${result.renter.official_name} `} نام پدر
                {` ${result.renter.official_fathers_name} `}به شماره ملی
                ................................. شماره تماس ثابت
                {` ${result.renter.fixed_phone} `} شماره همراه
                {` 0${result.renter.cell} `} نشانی اقامتگاه
                .........................................................................................................................................................................................
            ...
            <View>
              ...
              <Text style={styles.text}>
                ...
                به مدل {` ${result.rent_search_dump.year.name.fa} `} سیستم سوخت
                ................... دارای{" "}
                {` ${result.rent_search_dump.cylinder.name.fa}`}، به شماره شاسی
                ................................................. شماره
                موتور..................................................................
                رنگ {` ${result.rent_search_dump.color.name.fa}`}؛ و به شماره
                پلاک{" "}
                ...
                {` ${result.rent_search_dump.third_party_insurance_id}`} و تاریخ
                اعتبار{" "}
            ...
            <View>
              ...
              <Text style={styles.text}>
                مورد اجاره در تاریخ{` ${result.rent_search_dump.start_date} `}به
                مدت {` ${result.rent_search_dump.no_of_days} `}روز و
                ساعت...............در
                نشانی....................................................................................................................................
                به مستأجر تحویل شد.
              </Text>
              <Text style={styles.text}>
                ...
                {` ${result.rent_search_dump.end_date} `} و در
                ساعت................... در نشانی فوق به موجر عودت دهد.
              </Text>
              <Text style={styles.text}>
                مستأجر متعهد گردید از مورد اجاره شخصاً و فقط برای سواری و با
                تعداد سرنشین {` ${result.rent_search_dump.car.capacity} `} نفر و
                در شهر/شهرهای........................... و با مسافت حداکثر
                روزانه{` ${result.rent_search_dump.max_km_per_day} `}کیلومتر
                استفاده کند. کند و به ازای هر کیلومتر اضافه مبلغ
                {` ${(
                  result.rent_search_dump.extra_km_price * 10
                ).toLocaleString()} `}
                ریال معادل
                {` ${result.rent_search_dump.extra_km_price_name} `}پرداخت کند.
              </Text>
              <Text style={styles.text}>
            ...
            <View>
              ...
              <Text style={styles.text}>
                ...
                برای{` ${result.rent_search_dump.no_of_days} `}روز جمعاً به مبلغ
                {` ${(
                  result.rent_search_dump.total_price * 10
                ).toLocaleString()} `}
                ریال معادل{` ${result.rent_search_dump.total_price_name} `}
              ...
              {result.has_insurance ? (
                <Text style={styles.text}>
                  ...
                  ریال معادل
                  {` ${result.rent_search_dump.insurance_total_price_name} `} به
                  مدت {` ${result.rent_search_dump.no_of_days} `} روز است که
                  مستاجر آن را در وب‌سایت سپریس (اجاره آنلاین خودرو) پرداخت کرده
                  است.
                </Text>
              ) : null}
              <br />
              ...
              <Text style={styles.tabsareh_text}>
                ...
                ریال معادل{` ${result.rent_search_dump.extra_hour_price_name} `}
            ...
            <View>
              ...
              <Text style={styles.text_with_padding_flex}>
                ...
                <Text style={styles.text_with_padding_flex_sub_padding}>
                  ...
                  ........................ ریال معادل .......... میلیون تومان
                  بابت تضمین جرائم احتمالی راهنمایی و رانندگی و سایر هزینه‌ها
                  مانند اضافه کیلومتر، بنزین و خسارات احتمالی خودرو که در مدت
                  اجاره توسط مستأجر یا ثالث به وجود آمده، هم‌زمان با امضای
                  قرارداد اجاره به شماره
                  کارت...................................................بانک
                  ............ به نام ................................. و مبلغ
                  ۱۰.۰۰۰.۰۰۰ ریال معادل یک‌میلیون تومان به شماره کارت
                  {` ${result.system_representative_bacnk_account_id} `} –{" "}
                  {` ${result.system_representative_bacnk_name} `} به نام{" "}
                  {` ${result.system_representative_name} `} (نزد شرکت سپریس)
                  واریز نماید.
                </Text>
              </Text>
              <br />
              ...
              <Text style={styles.extra_padding}>
                مبلغ ....................................... ریال بعد از تحویل
                خودرو پس از کسر جرائم مشخص‌شده به مستأجر مسترد خواهد شد و مبلغ
                ۱۰.۰۰۰.۰۰۰ ریال معادل یک‌میلیون تومان باقیمانده پس از اخذ خلافی
                خودرو توسط موجر و پس از کسر جرائم راهنمایی و رانندگی در مدت
                اجاره و سایر هزینه‌های مربوط به آن و پس از ۲۰ روز کاری
                (مورخه................) به شماره
                کارت....................................................... –
                بانک ............... به نام
                ............................................. واریز خواهد شد.
              ...
              <Text style={styles.text_with_padding_flex}>
                ...
                <Text style={styles.text_with_padding_flex_sub_padding}>
                  ...
                  ........................................ به
                  مبلغ................................................ریال معادل
                  .................. تومان بابت تضمین خسارات وارده به خودرو،
                  مازاد اجاره بهاء، جرائم رانندگی، تعمیرات و سایر هزینه‌ها و
                  تخلفات و جرائم توسط مستأجر در هنگام امضای قرارداد به موجر
                  تحویل شد.
                </Text>
              </Text>
              <Text style={styles.extra_padding}>
                مستأجر ضمن این قرارداد به موجر اذن داد در صورت هرگونه تخلف از
                این قرارداد نسبت به نقد کردن چک فوق و کسر هزینه‌ها و جرائم و
                تخلفات ایجادشده در مدت اجاره، باقی مبلغ را به مستأجر مسترد
                نماید.
              </Text>
              <Text style={styles.extra_padding}>
                در صورت عدم تخلف و عدم بروز اختلاف بین موجر و مستأجر، چک فوق در
                روز تحویل (برگشت) خودرو به مستأجر عودت خواهد شد.
              </Text>
            </View>
            <View>
            ...
            <View>
              ...
              <Text style={styles.text}>
                این‌جانب................................. مستأجر قرارداد بارویت
                خودرو و کسب کلیه آموزش‌های استفاده خودرو توسط موجر، خودرو را از
                ایشان صحیح و سالم تحویل گرفتم.
              </Text>
              <Text style={styles.signature}>
                <Text>نام و امضای مستأجر</Text>
                <Text>نام و امضای موجر</Text>
