      ...
      <div className='content' ref={html_ref}>
        ...
        <div id='page_2'>
          ...
          <p>
            ...
            است که مستأجر آن را در وب‌سایت سپریس )&#1794;اجاره آنلاین
          ...
          <p>
            ...
            نقد نموده و پس از کسر خسارت دیرکرد، مازاد اجاره بهاء سایر هزینه‌ها
          ...
          <p>
            ...
            تمدیدی&#1794;، قرارداد اجاره منفسخ گردیده و مستأجر در صورت عدم عودت
            خودرو در پایان مدت قرارداد اجاره مسئول تمام خسارات خواهد
            بود&#46;&#1794;
          </p>
        ...
        <div id='page_3'>
          ...
          <p>
            ...
            مستأجر&#46;&#1794;
            <br />
            &#1794;۶- تحویل اصل کارت خودرو و بیمه‌نامه معتبر شخص ثالث به
            مستأجر&#46;&#1794;
          </p>
          <p>ماده هفت: تعهدات مستأجر</p>
          <p>
            &#1794;۱- استرداد خودرو با باک بنزین پر <br />
