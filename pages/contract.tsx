...
const Contract_page = () => {
  ...
  return result ? (
    <div className="contract_container">
      ...
      <div className="content" ref={html_ref} style={{ lineHeight: 2 }}>
        <h1
          style={{
            textAlign: "center",
            fontSize: "0.6rem",
        ...
        <h2 style={{ textAlign: "center", fontSize: "0.5rem", margin: 0 }}>
        ...
        <div id="page_3">
          ...
          >
            ...
            ، تعمیرات و سایر هزینه‌ها و تخلفات و جرائم توسط مستأجر در هنگام
            امضای قرارداد به موجر تحویل .شد مستأجر ضمن این قرارداد به موجر اذن
            داد در صورت هرگونه تخلف از این قرارداد نسبت به نقد کردن
            {result.deposit_type
              ? " " + result.deposit_type + " "
              : result.deposit_is_handed_over
              ? " سفته "
              : " چک "}
            فوق و کسر هزینه‌ها و جرائم و تخلفات ایجادشده در مدت اجاره ، باقی
          ...
          >
            ...
            موجر تماس برقرار نموده و با هماهنگی ایشان نسبت به حمل به تعمیرگاه )
            ...
            <br />
            -۸ مستأجر متعهد گردید جهت پارک خودرو در شب از پارکینگ استفاده نماید
            و در صورت سرقت و بروز هرگونه خسارتی در خارج از پارکینگ مستأجر
        ...
        <div id="page_4">
          ...
          >
            ...
            <br />
            -۱۰ در صورت بروز هرگونه تصادف ، تخلف و حادثه که مستلزم پیگیری اداری
